...
import { Counter, normalizeNearInteger, getValueRoundedToPlace } from '../../src/components/Counter'

vi.mock('motion/react')

describe('normalizeNearInteger', () => {
  it('should return the integer when exactly equal', () => {
    expect(normalizeNearInteger(5)).toBe(5)
  })

  it('should return the integer when very close (within tolerance)', () => {
    expect(normalizeNearInteger(5.0000000001)).toBe(5)
  })

  it('should return the original number when not close to any integer', () => {
    expect(normalizeNearInteger(5.3)).toBe(5.3)
  })

  it('should handle negative numbers', () => {
    expect(normalizeNearInteger(-3)).toBe(-3)
    expect(normalizeNearInteger(-3.0000000001)).toBe(-3)
  })

  it('should handle zero', () => {
    expect(normalizeNearInteger(0)).toBe(0)
  })

  it('should handle large numbers', () => {
    expect(normalizeNearInteger(1000000)).toBe(1000000)
    expect(normalizeNearInteger(1000000.0000000001)).toBe(1000000)
  })
})

describe('getValueRoundedToPlace', () => {
  it('should extract ones digit', () => {
    expect(getValueRoundedToPlace(42, 1)).toBe(42)
  })

  it('should extract tens digit', () => {
    expect(getValueRoundedToPlace(42, 10)).toBe(4)
  })

  it('should extract hundreds digit', () => {
    expect(getValueRoundedToPlace(425, 100)).toBe(4)
  })

  it('should handle decimal places', () => {
    expect(getValueRoundedToPlace(3.14, 0.1)).toBe(31)
  })

  it('should handle zero value', () => {
    expect(getValueRoundedToPlace(0, 1)).toBe(0)
  })

  it('should floor the result', () => {
    expect(getValueRoundedToPlace(49, 10)).toBe(4)
  })
})
